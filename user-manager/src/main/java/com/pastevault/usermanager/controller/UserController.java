...
public class UserController {
    ...
    @GetMapping
    public List<UserDTO> listUsers(@RequestParam(value = "page", defaultValue = "0") int page,
    ...
    @PutMapping("/{userId}")
    public UserDTO createUser(@PathVariable("userId") int userId, @RequestBody @Valid EditUser editUser) {
